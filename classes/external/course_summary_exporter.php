 ...
 */
namespace block_catalogue\external;
...
class course_summary_exporter extends \core\external\exporter {
    ...
    public function __construct($data, $related = array()) {
        ...
        if (!array_key_exists('courseadmin', $related)) {
            $related['courseadmin'] = false;
        }
        if (!array_key_exists('actionmenu', $related)) {
            $related['actionmenu'] = false;
        }
        if (!array_key_exists('tags', $related)) {
          $related['tags'] = '';
        }
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        return array(
            ...
            'actionmenu' => $this->related['actionmenu'],
