...
final class catalogue_test extends \advanced_testcase {
    ...
    public function test_get_block_config_for_external(): void {
        ...
        set_config('displaygroupingcustomfield', 1, 'block_catalogue');
        set_config('customfiltergrouping', $field->get('shortname'), 'block_catalogue');
        ...
        foreach ($blocks as $region => $regionblocks) {
            ...
            foreach ($regioninstances as $ri) {
                // Look for catalogue block only.
                if ($ri->instance->blockname == 'catalogue') {
        ...
        $this->assertEquals(get_config('block_catalogue', 'version'), $configs->plugin->version);
        // Test custom fields.
