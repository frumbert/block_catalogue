 ...
 *
 * @module block_catalogue/repository
 ...
 *
 * @method getCatalogueCourses
 * @param {object} args The request arguments
 * @return {promise} Resolved with an array of courses
 */
export const getCatalogueCourses = args => {
  const request = {
    methodname: 'block_catalogue_get_filtered_courses',
    args: args
  };
  const result = Ajax.call([request])[0];
  // console.log('getCatalogueCourses ajax call', request, result);
  return result;
};
