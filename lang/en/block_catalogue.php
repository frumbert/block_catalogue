...
/**
 * Lang strings for the My catalogue block.
 *
...
$string['aria:controls'] = 'Course catalogue controls';
...
$string['aria:choosecategory'] = 'Category to filter view to';
$string['aria:sortingdropdown'] = 'Sorting drop-down menu';
$string['aria:tags'] = 'Tag list';
...
$string['setting:showtags'] = 'Show tags?';

$string['future'] = 'Future';
$string['inprogress'] = 'In progress';
$string['lastaccessed'] = 'Last accessed';
$string['published'] = 'Date published';
$string['layouts'] = 'Available layouts';
$string['layouts_help'] = 'Course catalogue layouts which are available for selection by users. If none are selected, the card layout will be used.';
$string['list'] = 'List';
$string['catalogue:myaddinstance'] = 'Add a new course catalogue block to Dashboard';
$string['nocustomvalue'] = 'No {$a}';
$string['past'] = 'Past';
$string['pluginname'] = 'Course catalogue';
$string['privacy:metadata:overviewsortpreference'] = 'The Course catalogue block sort preference.';
$string['privacy:metadata:overviewviewpreference'] = 'The Course catalogue block view preference.';
$string['privacy:metadata:overviewgroupingpreference'] = 'The Course catalogue block grouping preference.';
$string['privacy:metadata:overviewpagingpreference'] = 'The Course catalogue block paging preference.';
...
$string['sortbycategoryname'] = 'Sort by category name';
...
$string['logcourse'] = 'Course logs';
$string['category'] = 'Category';
$string['anycategory'] = 'Any category';

$string['setting:topcategoryid'] = 'Top category id';
$string['setting:topcategoryid_desc'] = 'List courses in or under this parent category id';
$string['setting:sortbycategories'] = 'Show sort by category';
